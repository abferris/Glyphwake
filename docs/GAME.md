...
- **Scale:** ~300m island radius, with a terrain height up to ~169m; a sea floor 20m below sea level at the island edges.
- **Terrain style:** Stylized/beige ground, painted with flat-color grass, sand, dirt, and rock layers.
- **Water:** A water plane with a transparent blue material, positioned at sea level.
...
- **Physics:** Uses CharacterController (not Rigidbody); gravity handled manually.
